...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center text-muted-foreground border-b-[1px] border-b-slate-500',
      className
    )}
    {...props}
  />
